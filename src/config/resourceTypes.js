...
export const RESOURCE_TYPES = {
    WOOD: {
        ...
        name: 'Wood',
        icon: '🪵', // Emoji for UI
        description: 'Logs harvested from trees, used for construction and crafting.'
    },
    WOOD_LOG: {
        key: 'WOOD_LOG',
        name: 'Wood Log',
    ...
    STONE: {
        ...
        description: 'Rough stone quarried from deposits, a primary building material.'
    },
    GRAIN: {
        key: 'GRAIN',
        name: 'Grain',
    ...
    IRON_ORE: {
        ...
        description: 'Raw ore containing iron, needs to be smelted for tools and weapons.'
    },
    COAL_ORE: {
        key: 'COAL_ORE',
        name: 'Coal Ore',
    ...
    TREE: { // The harvestable resource on the map
        key: 'TREE',
        name: 'Tree',
        isHarvestable: true,
        yield: { 'WOOD_LOG': 5 }, // Produces 5 of the resource with key 'WOOD_LOG'
...
// Helper function to quickly access a resource type by its key
export function getResourceType(key) {
    return RESOURCE_TYPES[key] || null;
}