...
const allTerrainCreators = {
    ...
    MountainSmall: () => Terrains.createMountain({ width: 6, depth: 6, height: 2.5 }), // Small mountain, no snow
    MountainMedium: () => Terrains.createMountain({ width: 7, depth: 7, height: 4 }), // Medium, should have snow
    MountainLarge: () => Terrains.createMountain({ width: 8, depth: 8, height: 6 }), // Large, should have snow
